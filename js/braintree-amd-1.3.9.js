/*!
 * Braintree AMD
 * https://github.com/christianreed/braintree-amd.js
 *
 * This is a fork of Braintree End-to-End Encryption Library
 * https://www.braintreepayments.com
 * Copyright (c) 2009-2013 Braintree Payment Solutions
 *
 * This code is as-is. Use at your own risk. If you find issues
 * please submit them.
 *
 * JSBN
...
}(this, function (jQuery) {// ASN.1 JavaScript decoder
// Copyright (c) 2008-2009 Lapo Luchini <lapo@lapo.it>
...
Braintree.EncryptionClient = function (publicKey) {
  ...
  var extractForm = function (object) {
    if (jQuery && object instanceof jQuery) {
      return object[0];
  ...
  self.onSubmitEncryptForm = function (form, callback) {
    ...
    if (jQuery) {
      jQuery(form).submit(wrappedCallback);
